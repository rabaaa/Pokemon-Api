...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    var str =  pokemonIndex;
    var arr = str.split("-");

    const { pokemonIndex1 } = arr[1];

    debugger;

    const pokemonUrl11 = `https://pokeapi.co/api/v2/pokemon/${arr[1]}/`;
    const pokemonSpeciesUrl11 = `https://pokeapi.co/api/v2/pokemon-species/${arr[1]}/`;


    debugger;
    // these are both of the end points 
    const pokemonUrl = `https://pokeapi.co/api/v2/pokemon/${arr[0]}/`;
    const pokemonSpeciesUrl = `https://pokeapi.co/api/v2/pokemon-species/${arr[0]}/`;

    debugger;

    const pokemonUrl1 = `https://pokeapi.co/api/v2/pokemon/${arr[1]}/`;
    const pokemonSpeciesUrl1 = `https://pokeapi.co/api/v2/pokemon-species/${arr[1]}/`; 
